            ...
            <div class="l-container">
                <div class="c-2col-contents__item">
                    ...
                    <div class="c-2col-contents-body">
                        <h2 class="c-2col-contents-item-title">導入ハードルが低い理由</h2>
                        <p class="c-2col-contents-item-text">太陽光発電システムの導入は、以前と比べてずっと身近になりました。近年では技術革新により、様々な屋根の形や素材にも対応できる柔軟性が増しています。また、国や自治体による補助金制度を活用できるケースも多く、初期費用を抑えることが可能です。アミカブルサービスでは、お客様の状況に合わせた最適なプランを分かりやすくご提案し、導入までを丁寧にお手伝いするため、初めての方でも安心して設置を進められます。</p>
                    </div>
                </div>
            </div>
        </section>
